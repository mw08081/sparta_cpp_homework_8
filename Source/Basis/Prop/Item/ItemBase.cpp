...
{
	UE_LOG(LogTemp, Display, TEXT("Overlap actor name: %s"), *OtherActor->GetActorLabel());

	OnItemTaken(OtherActor);
}

void AItemBase::OnItemTaken(AActor* Taker)
{
	UE_LOG(LogTemp, Display, TEXT("Item Taken"));
